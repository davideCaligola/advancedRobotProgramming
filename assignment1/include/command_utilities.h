...
WINDOW *vx_incr_btn, *vx_decr_btn, *vx_stp_button, *vz_incr_btn, *vz_decr_btn, *vz_stp_button, *close_btn;
// Mouse event var
MEVENT event;
...
void make_buttons() {
    ...
    // close button
    close_btn = newwin(BTN_SIZE_Y, BTN_SIZE_X, close_button_starty, close_button_startx);
}
